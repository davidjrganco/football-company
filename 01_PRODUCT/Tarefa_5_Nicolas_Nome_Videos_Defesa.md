...
2-3 repetições bem feitas · bola e pés visíveis. O pai envia os ficheiros.
...
inventar. Propostas (✅ = entra, risca o que não queres):

| | Exercício | Como é |
|---|---|---|
| [ ] | Sombra Defensiva | deslocamento lateral em posição de defesa entre 2 cones, sem cruzar os pés |
| [ ] | Corta-Linhas | o pai (ou a parede) faz passes e tu cortas a linha de passe |
| [ ] | 1v1 Defensivo | defende o cone/mini-baliza contra o pai — aguenta sem que ele passe |
| [ ] | Roubo Limpo | pressiona o portador e rouba a bola sem falta |
| [ ] | Fecha-Espaço | ao sinal (palma), fecha o espaço a correr e trava em posição defensiva |
| [ ] | Cabeceamento de Área | afasta de cabeça a bola lançada pelo pai |
...
- [ ] **Recordes pessoais** — a app guarda os teus máximos (toques no juggling, tempo na prancha) e desafia-te a batê-los
- [ ] **Sons e celebrações** — som de estádio ao concluir, golo ao completar programa

---

Assinatura do Fundador & Diretor de Treino: ______________________  Data: ____/____/2026
